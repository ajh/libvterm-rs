...
extern "C" fn put_glyph(info: *mut ffi::VTermGlyphInfo, pos: ffi::VTermPos, vterm: *mut c_void) -> c_int {
...
extern "C" fn move_rect(dest: ffi::VTermRect, srd: ffi::VTermRect, vterm: *mut c_void) -> c_int {
    0
}
...
extern "C" fn set_pen_attr(attr: ffi::VTermAttr, val: *mut ffi::VTermValue, vterm: *mut c_void) -> c_int {
    0
}
//int (*settermprop)(VTermProp prop, VTermValue *val, void *user);
extern "C" fn set_term_prop(prop: ffi::VTermProp, val: *mut ffi::VTermValue, vterm: *mut c_void) -> c_int {
    0
}
//int (*bell)(void *user);
...
extern "C" fn resize(rows: c_int, cols: c_int, delta: *mut ffi::VTermPos, vterm: *mut c_void) -> c_int {
    0
}
//int (*setlineinfo)(int row, const VTermLineInfo *newinfo, const VTermLineInfo *oldinfo, void *user);
extern "C" fn set_line_info(row: c_int, new: *const ffi::VTermLineInfo, old: *const ffi::VTermLineInfo, vterm: *mut c_void) -> c_int {
    0
}
